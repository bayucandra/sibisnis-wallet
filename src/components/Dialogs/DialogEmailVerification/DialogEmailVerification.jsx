...
import "./DialogEmailVerification.scss";

class DialogEmailVerification extends Component {
  ...
  _outerModalClose = () => {
    ...
    biqHelper.utils.clickTimeout( () => {
      ...
      dispatch( appActions.appDialogEmailClose() );
    } );
  };
  ...
  render() {
    ...
    return (
      ...
      <Modal
        open={this.props.dialog_email_input.is_open}
        onClose={this._outerModalClose}
      >
        ...
        <div className="modal-inner">
          ...
          <div className={`email-verification-dialog`} style={ { marginTop: this.state.modalPosTop } }>
            ...
            <Button className="modal-close-btn" onClick={this._outerModalClose} >&nbsp;</Button>
...
const mapStateToProps = state => {
  ...
  return {
    ...
    dialog_email_input: state.app.dialog_email_input
  };

};

export default connect( mapStateToProps ) ( DialogEmailVerification );
