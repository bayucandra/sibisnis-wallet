  ...
  render() {
    ...
    return (
      <div className="balance-payment-status-bank">
        ...
        <div className="balance-payment-status-bank__header">
          {
        ...
        <div className="balance-payment-status-bank__body">

          <div className="balance-payment-status-bank__main-panel">
            {
              data.status !== '3' ?
          ...
          <div className="balance-payment-status-bank__spacer visible-md-up"/>
...
export default connect( mapStateToProps )(BalancePaymentStatusBank);